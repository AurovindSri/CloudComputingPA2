...
if __name__ == "__main__":
    ...
    spark = SparkSession.builder.appName('ap2868_cs643').getOrCreate()
    ...
    if len(sys.argv) > 3:
        ...
        input_path = "s3://wine-data-ap2868/train.csv"
        valid_path = "s3://wine-data-ap2868/valid.csv"
        output_path="s3://wine-data-ap2868/testmodel.model"
